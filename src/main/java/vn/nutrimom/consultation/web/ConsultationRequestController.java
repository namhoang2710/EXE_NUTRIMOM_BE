...
public class ConsultationRequestController {
    ...
    @GetMapping
    @Operation(summary = "Danh sách yêu cầu tư vấn của chính mình")
    public ApiResponse<List<ConsultationRequestResponse>> listOwn(@AuthenticationPrincipal Jwt jwt) {
        return ApiResponses.success(requestService.listOwn(jwt.getSubject()));
    }
